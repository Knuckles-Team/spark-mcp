"""Graph-based Pydantic AI agent server entry point for spark-mcp."""
...
def agent_server():
    """Start the graph-based Pydantic AI agent server for Spark."""
    ...
    DEFAULT_AGENT_DESCRIPTION = os.getenv(
        ...
        meta.get(
            "description",
            "AI agent for Spark Connect (Iceberg lakehouse transform) operations.",
        ),
    )
